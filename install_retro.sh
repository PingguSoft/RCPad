...
sudo sed -i 's/APP_PATH      = "."/APP_PATH      = "\/opt\/retropie\/configs\/all/RCPad-Pie"/' /opt/RCPad-Pie/RCPad-Pie.py
...
sudo /usr/bin/python /opt/retropie/configs/all/RCPad-Pie/RCPad-Pie.py &
